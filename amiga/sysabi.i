...
; Contract-owned (CONTRACT-ARCH Phase 4): generated by unogen from unodef/unodef.toml
; ([world.amiga]) so these can no longer drift from the Contract. Byte-identical to
; the hand-maintained block this include replaced.
            include "../unodef/gen/amiga/sysabi_gen.i"
