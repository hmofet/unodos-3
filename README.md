...
| [**Sony PS2**](ps2/) | PlayStation 2 (MIPS R5900 EE, 32MB, Graphics Synthesizer), FreeMcBoot ELF | Port the portable C core ([mac/unodos.c](mac/unodos.c)) over a software 640×448×32 framebuffer blitted to GS each vsync; DualShock 2 + soft keyboard | **Milestone 0** — software-FB platform layer + shared font + hello-GS splash; EE ELF builds with the ps2dev toolchain and **runs on the emulated GS** (PCSX2 v2.6.3 + 4MB PS2 BIOS, `ps2/shots/m0_pcsx2.png`); real-hardware run pending |
